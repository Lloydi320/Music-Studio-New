    ...
    <div class="booking-layout">
        ...
        <div class="customer-info-section">
            ...
            <div class="customer-card">
                ...
                <!-- General Actions -->
                <div class="action-buttons" style="margin-top: 15px; padding-top: 15px; border-top: 1px solid #e0e0e0;">
                    <a href="mailto:{{ $rental->user->email }}" class="btn btn-secondary">
                    ...
                    <a href="{{ route('rental.calendar.export', $rental->id) }}" class="btn btn-info">
                        <i class="fas fa-calendar-download"></i> Download ICS
                    </a>
                </div>
            </div>
        </div>
