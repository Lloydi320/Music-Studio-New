...
<body class="booking-page">
  ...
  <style>
    /* Policy Modal Styles (unified) */
    #policyModal .modal-content { background:#fff; border-radius:16px; width:95%; max-width:640px; overflow:hidden; box-shadow:0 16px 32px rgba(0,0,0,0.15); }
    #policyModal .modal-header { padding:18px 20px; border-bottom:1px solid #f0f0f0; display:flex; justify-content:space-between; align-items:center; background:#fafafa; border-radius:16px 16px 0 0; }
    #policyModal .modal-title { margin:0; color:#333; font-size:1.25rem; font-weight:600; }
    #policyModal .modal-close { background:none; border:none; font-size:28px; color:#666; cursor:pointer; padding:0; width:36px; height:36px; display:flex; align-items:center; justify-content:center; border-radius:50%; transition:all 0.25s ease; }
    #policyModal .modal-close:hover { background:#f0f0f0; color:#333; transform:scale(1.05); }
    #policyModal .modal-body { padding:20px; color:#555; line-height:1.6; }
    #policyModal .modal-body h3 { color:#333; margin:6px 0 12px; font-size:1.1rem; }
    #policyModal .modal-body p { margin:6px 0; }
    @media (max-width:768px){ #policyModal .modal-content{ max-width:calc(100% - 20px);} #policyModal .modal-header, #policyModal .modal-body { padding-left:16px; padding-right:16px; } }
  </style>
