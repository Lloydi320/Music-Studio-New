...
<body>
  ...
  <header class="navbar">
    <div class="logo">
      <img src="images/studio-logo.png" alt="Lemon Hub Studio Logo">
  ...
  <section class="hero">
    <div class="hero-overlay" id="mainOverlay">
      <div class="hero-content">
        ...
        <a href="services.html#our-services" class="book-btn">Book Now!</a>
      </div>
  ...
  <footer class="footer-logo">
    <img src="images/studio-logo.png" alt="Studio Logo" />
  </footer>
